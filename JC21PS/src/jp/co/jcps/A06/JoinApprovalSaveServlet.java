...
public class JoinApprovalSaveServlet extends HttpServlet {
	...
	private void saveClubMember(String registClubId, String registUserId) throws Exception {
		...
		//SQLを宣言
		// TODO: SQL文を完成させなさい。
		String sql = "INSERT INTO turn_club_menber VALUES(registClubID,registUserID)";
	...
	private void deleteJoinRequest(String registClubId, String registUserId) throws Exception {
		...
		//SQLを宣言
		// TODO: SQL文を完成させなさい。
		String sql = "DELETE FROM trn_join_request WHERE  trn_join_request.user_id = registUserID AND trn_join_request.club_ID = registClubID ";
